...
COpenATCHardwareManager    // 硬件管理
COpenATCMainCtlManager     // 主控制管理
CCanBusManager            // CAN总线管理
COpenATCFaultProcManager  // 故障处理管理
COpenATCLogicCtlManager   // 逻辑控制管理
COpenATCFlowProcManager   // 流程管理
COpenATCComCtlManager     // 通信控制管理
