...
#ifndef OPENATCDATAPACKUNPACK_H
#define OPENATCDATAPACKUNPACK_H
...
class COpenATCDataPackUnpack : public COpenATCPackUnpackBase    
{
public:
	COpenATCDataPackUnpack();
	virtual ~COpenATCDataPackUnpack();
...
protected:
	enum
	{
		CN_MAX_RECVBUFFER_SIZE = 1 * 1024 * 1024,
	};

	vector<char>    unpackCache_;	                    //接收缓冲区
};

#endif  //!ifndef OPENATCDATAPACKUNPACK_H
